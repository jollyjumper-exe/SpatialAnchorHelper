...
public class SpatialAnchorsHelperUI : MonoBehaviour
{
    ...
    void Start()
    {
        if (SpatialAnchorManager.Instance != null) _spatialAnchorManager = SpatialAnchorManager.Instance;
    }
    ...
    private void PlaceSpatialAnchorAtController()
    {
        ...
        _spatialAnchorManager.CreateSpatialAnchor(position, rotation, _currentPrefabPath, _currentAnchorType);
    ...
    {
        _spatialAnchorManager.LoadSpatialAnchors(layoutID);
    }

    public void SaveSpatialAnchors()
    {
        _spatialAnchorManager.SaveSpatialAnchors(layoutID);
    }
